...
export default function ServiceCard({ title, description }: ServiceCardProps) {
  return (
    <div className="group glass-effect rounded-2xl p-8 border border-[rgba(244,204,126,0.30)] hover:border-[rgb(244,204,126)] transition-all duration-300 hover:shadow-2xl hover:shadow-[rgba(244,204,126,0.20)] hover:-translate-y-2 animate-fade-in">
