...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-neutral-950 via-zinc-900 to-black">
      {/* Hero Section */}
      <section id="home" className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden" aria-labelledby="hero-heading">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <h1 id="hero-heading" className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 animate-fade-in">
            Pándi Travel
          </h1>
      ...
      {/* About Section */}
      <section id="about" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20" aria-labelledby="about-heading">
        <article className="glass-effect rounded-3xl p-8 md:p-12 border-[rgba(244,204,126,0.30)] animate-fade-in hover:shadow-2xl hover:shadow-[rgba(244,204,126,0.20)] transition-all duration-500">
          <h2 id="about-heading" className="text-4xl font-bold text-white mb-6 text-center">
            Rólunk
          </h2>
          <div className="h-1 w-24 bg-gradient-to-r from-[rgb(244,204,126)] to-[rgb(244,204,126)] mx-auto mb-8 rounded-full" aria-hidden="true"></div>
              ...
              {pricings.map((pricing, index) => (
                ...
                >
                  <header className="flex items-center justify-between mb-4">
                    ...
                    <div className="w-12 h-12 bg-gradient-to-br from-[rgb(244,204,126)] to-[rgb(244,204,126)] rounded-xl flex items-center justify-center" aria-hidden="true">
      ...
      <section id="booking" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50" aria-labelledby="booking-heading">
        <div className="max-w-2xl mx-auto">
          <h2 id="booking-heading" className="text-4xl font-bold text-white mb-4 text-center animate-fade-in">
            Foglalás
          </h2>
          <div className="h-1 w-24 bg-gradient-to-r from-[rgb(244,204,126)] to-[rgb(244,204,126)] mx-auto mb-12 rounded-full animate-fade-in" aria-hidden="true"></div>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="contact-heading">
        <div className="max-w-6xl mx-auto">
          <h2 id="contact-heading" className="text-4xl font-bold text-white mb-4 text-center animate-fade-in">Kapcsolat</h2>
          <div className="h-1 w-24 bg-gradient-to-r from-[rgb(244,204,126)] to-[rgb(244,204,126)] mx-auto mb-12 rounded-full animate-fade-in" aria-hidden="true"></div>
            ...
            <div className="space-y-8 animate-fade-in lg:self-start">
              ...
              <div className="flex justify-center lg:justify-start">
                <div className="relative w-80 h-80 bg-black p-0">
                  <Image
                    src="/logo.jpeg"
                    alt="Pándi Travel logó - Prémium Tesla személyszállítás"
                    fill
              ...
              <address className="space-y-6 not-italic">
                ...
                <div>
                  ...
                  <a 
                    ...
                    aria-label="Pándi Travel cím Google Mapsen"
                  >
                ...
                <div>
                  ...
                  <a 
                    ...
                    aria-label="Írjon nekünk: contact@pandi-travel.hu"
                  >
          ...
          {/* Footer */}
          <footer className="text-center pt-12 px-8 py-10 bg-black rounded-2xl mt-12">
            <nav className="flex justify-center items-center space-x-6 mb-6" aria-label="Közösségi média linkek">
              <a
                href="https://www.facebook.com/profile.php?id=61579373423666"
                target="_blank"
                rel="noopener noreferrer"
                className="group"
                aria-label="Látogassa meg a Pándi Travel Facebook oldalát"
              >
